...
function library:CreateSettingsTab(menu)
    ...
    mainSection:AddSlider({text = 'x position', flag = 'watermark_x', suffix = '%', min = 0, max = 100, increment = .1, value = 6});
    mainSection:AddSlider({text = 'y position', flag = 'watermark_y', suffix = '%', min = 0, max = 100, increment = .1, value = 1});

    mainSection:AddToggle({text = 'keybinds', flag = 'keybind_indicator', state = false,});
    mainSection:AddSlider({text = 'x position', flag = 'keybind_indicator_x', min = 0, max = 100, increment = .1, value = .5, callback = function()
    ...
    mainSection:AddSlider({text = 'y position', flag = 'keybind_indicator_y', min = 0, max = 100, increment = .1, value = 30, callback = function()
        library.keyIndicator:SetPosition(newUDim2(library.flags.keybind_indicator_x / 100, 0, library.flags.keybind_indicator_y / 100, 0));    
    end});
